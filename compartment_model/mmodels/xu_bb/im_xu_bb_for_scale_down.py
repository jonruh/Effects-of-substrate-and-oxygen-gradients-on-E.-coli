...
class im_xu_bb(object):
    ...
    def im_bmodel_odes(self,t,y,kla_fp_array,kla_xp_array,pabs,yO_in,Sf,D_fp_array,D_xp_array,V_fixed,X_fixed,D_set,pulse_cycle_time,pulse_on_ratio,returns):
        ...
        kla_fp_array: Array of kla. Must be same lenght as kla_xp_array (mass transfer coefficient for oxygen transfer [1/h]).
        kla_xp_array: Array of time values associated to kla_fp_array. Must be same lenght as kla_fp_array.
        pabs: absolute pressure [bar]
        yO_in: oxygen mol fraction in the gas phase [-]
        ...
        D_fp_array: Array of dilution rate. Must be same lenght as D_xp_array.
        D_xp_array: Array of time values associated to D_fp_array. Must be same lenght as D_fp_array.
        ...
        # OTR = kla*(O_star-O)
        ### [mmol/L/h] oxygen transfer rate (changed to accomodate oscillations in kla)
        kla = np.interp(t, kla_xp_array , kla_fp_array)
        OTR = kla*(O_star-O)
        ...
        if returns == 'dydt':
            ...
            # Fed-batch mode
                ...
                D = np.interp(t, D_xp_array, D_fp_array)
