...
class im_xu_bb(object):
    ...
    def __init__(self,strain_id:str=None,strain_description:str=None):
        ...
        self.species['species'] = ['X','S','O','A','yO']
        self.species['description'] = ['biomass concentration','substrate concentration','dissolved oxygen concentration','acetate concentration','oxygen mol fraction in gas phase']
    ...
    def im_bmodel_odes(self,t,y,kla,pabs,VL,Vg,yO_in,airflow,Sf:float,mu_set:float,Vm:float=25.0,V_fixed:bool=False,X_fixed:bool=False,D_set:float=0,pulse_cycle_time:float=None,pulse_on_ratio:float=None,returns:str='dydt'):
        ...
        if returns == 'dydt':
            ...
            # dyOdt
            dyOdt = (airflow*60/Vm*(yO_in-yO)-OTR*VL/1000)/(Vg/Vm)
